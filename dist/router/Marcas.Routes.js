...
const Marcas_Middleware_1 = require("../middleware/Marcas/Marcas.Middleware");
const Marcas_Validator_1 = require("../Validators/Marcas/Marcas.Validator");
 ...
 */
router.get("/", Marcas_Validator_1.validateGetAllMarcas, Marcas_Middleware_1.handleValidationErrors, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get("/:id", Marcas_Validator_1.validateGetMarcaById, Marcas_Middleware_1.handleValidationErrors, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.post("/", Marcas_Validator_1.validateCreateMarca, Marcas_Middleware_1.handleValidationErrors, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.put("/:id", Marcas_Validator_1.validateUpdateMarca, Marcas_Middleware_1.handleValidationErrors, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id, 10);
    const { nombre, nomenclatura } = req.body;
    try {
 ...
 */
router.delete("/:id", Marcas_Validator_1.validateDeleteMarca, Marcas_Middleware_1.handleValidationErrors, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id, 10);
    try {
